...
# A Quick Admin Security Checklist ✅  

- 🔒 **Review and minimize user permissions** (Principle of Least Privilege).  
- 👤 **Audit profiles** and replace with Permission Sets where possible.  
- 🔑 **Enable and enforce Multi-Factor Authentication (MFA)** for all users.  
- 🛡 **Regularly review and tighten Field-Level Security (FLS) and Sharing Rules.**  
- 🚪 **Deactivate inactive users** and monitor login history.  
- 📦 **Review and remove unused Connected Apps and Installed Packages.**  
- 📊 **Enable monitoring tools**: Login Forensics, Health Check, and Transaction Security.  
- 📅 **Schedule regular security reviews** (quarterly at minimum).  
- 💾 **Back up data** and test recovery procedures.  
- 📢 **Stay updated with Salesforce Security advisories and releases.**  
